    ...
    <div class="container">
        <div class="slider-active">
            <div class="slider-single-item">
                <img src="{{ asset('assets') }}/img/slider-img2.jpg" class="img-fluid" alt="no image">
            ...
            <div class="slider-single-item">
                <img src="{{ asset('assets') }}/img/slider-img2.jpg"  class="img-fluid" alt="">
                <div class="slider-text">
                    <h2>Cherner <span>Armchair</span></h2>
                    <p>The 1958 moulded plywood armchair by Norman Cherner.</p>
                    <a href="#">View now</a>
            ...
            <div class="slider-single-item">
                <img src="{{ asset('assets') }}/img/slider-img3.jpg" class="img-fluid" alt="">
                <div class="slider-text">
                    <h2>Cherner <span>Armchair</span></h2>
                    <p>The 1958 moulded plywood armchair by Norman Cherner.</p>
                    <a href="#">View now</a>
                ...
                <!--Single product start-->
                              <div class="product-wrapper">
                                  <div class="product-img">
                                      <a href="{{ route('product_detail',$product->id) }}"> <img src="{{ asset('uploads/product_image') }}/{{ $product->product_image }}" alt=""></a>
                                      {{--  <a href="#"> <img class="secondary-img" src="{{ asset('assets') }}/img/product-img/product1.jpg"
                                              alt=""></a>  --}}
                                      <span>hot</span>
                                  ...
                                  <div class="product-content text-center">
                                      <h3><a href="{{ route('product_detail',$product->id) }}">{{ $product->product_name }}</a></h3>
                                      <div class="rating">
            ...
            <div class="col-xl-12">
                <div class="product-tab">
                    <ul class="nav" role="tablist">
                        ...
                        <li class="nav-item  pb-5">
                            <a class="nav-link" data-toggle="tab" href="#tab{{ $all_category->id }}" role="tab">{{ $all_category->category_name }}</a>
                        </li>
                        @endforeach
                        
                    </ul>
                    <div class="tab-content">
                        {{--  for all products in tab  --}}
                        <!--Tab start-->
                        <div class="tab-pane fade show active" id="all" role="tabpanel">
                            ...
                            <div class="product-active owl-carousel nav-style">
                                ...
                                <div class="product-wrapper">
                                    ...
                                    <div class="product-content text-center">
                                        <h3><a href="{{ route('product_detail',$all_product->id) }}">{{ $all_product->product_name }}</a></h3>
                                        <div class="rating">
                                            <i class="fas far fa-star"></i>
                                            <i class="fas far fa-star"></i>
                                            <i class="fas far fa-star"></i>
                        ...
                        @foreach($all_categories as $key => $all_category)
                        <!--Tab start-->
                        <div class="tab-pane fade" id="tab{{ $all_category->id }}" role="tabpanel">
                            <!--owl-carousel start-->
                            <div class="product-active owl-carousel nav-style">
                                <!--Single product start-->
                                @foreach($all_products as $key => $all_product)
                                ...
                                <div class="product-wrapper">
                                    <div class="product-img">
                                        <a href="#"> <img src="{{ asset('uploads/product_image') }}/{{ $all_product->product_image }}" alt=""></a>
                                        {{--  <a href="#"> <img class="secondary-img" src="{{ asset('assets') }}/img/product-img/product1.jpg"
                                                alt=""></a>  --}}
                                        <span>hot</span>
                                        <div class="product-action">
...
<div class="banner-area pb-5">
    <div class="container">
        <div class="banner-img">
            <a href="#"><img class="img-fluid" src="{{ asset('assets') }}/img/banner-img/banner.jpg" alt=""></a>
        </div>
    </div>
</div>
<!--Product Area-->
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="furniture1" role="tabpanel" aria-labelledby="l1">
                            <div class="product-active owl-carousel nav-style">
                                <div class="product-wrapper">
                                    <div class="product-img">
                                        <a href="#"> <img src="{{ asset('assets') }}/img/product-img/product1.jpg" alt=""></a>
                                        <a href="#"> <img class="secondary-img" src="{{ asset('assets') }}/img/product-img/product2.jpg"
                                                alt=""></a>
                                        <div class="product-action">
                                            <a href="#"><i class="far fa-eye"></i></a>
                                            <a href="#"><i class="fas fa-balance-scale"></i></a>
                                ...
                                <div class="product-wrapper">
                                    <div class="product-img">
                                        <a href="#"> <img src="{{ asset('assets') }}/img/product-img/product3.jpg" alt=""></a>
                                        <a href="#"> <img class="secondary-img" src="{{ asset('assets') }}/img/product-img/product2.jpg"
                                                alt=""></a>
                                        <div class="product-action">
                                            <a href="#"><i class="far fa-eye"></i></a>
    ...
    <div class="container ">
        <div class="row">
            <div class="brand-active owl-carousel ">
                <div class="single-brand"><a href=""><img src="{{ asset('assets') }}/img/brand/brand1.jpg" alt="" class=""></a></div>
                <div class="single-brand"><a href=""><img src="{{ asset('assets') }}/img/brand/brand1.jpg" alt="" class=""></a></div>
                <div class="single-brand"><a href=""><img src="{{ asset('assets') }}/img/brand/brand1.jpg" alt="" class=""></a></div>
                <div class="single-brand"><a href=""><img src="{{ asset('assets') }}/img/brand/brand1.jpg" alt="" class=""></a></div>
                <div class="single-brand"><a href=""><img src="{{ asset('assets') }}/img/brand/brand1.jpg" alt="" class=""></a></div>
