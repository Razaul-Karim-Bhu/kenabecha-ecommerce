                ...
                <div class="options-area">
                   ...
                   <form action="{{ route('add_to_cart') }}" method="POST" class="cart-and-action">
                    ...
                    <div class="quanty clearfix mb-5">
                        <label class="float-left px-2" for="">quantity</label>
                        <div class="float-left">
                        <input type="number" name="product_quantity" id="" min="1" value="1">
                        <input type="hidden" name="product_id" value="{{ $product->id }}" id="" min="1" value="1">
                        </div>
                    </div>
                    <div class="cart-pro ">
...
<div class="product-info-area pt-5">
    <div class="container">
        ...
        <div class="tab-content pt-4 active show">
            ...
            <div class="product-active owl-carousel nav-style">
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="{{ route('product_detail',$related_product->id) }}"> <img src="{{ asset('uploads/product_image') }}/{{ $related_product->product_image }}" alt=""></a>
